...
public class Pais { 
    ...
    //Operacion
    public Double calcPPC(String nombrePais) { //Clase envolvente de double
        if (getNombre().equalsIgnoreCase(nombrePais)) {
            return (getPBI() * 100000) / getPoblacion();
        } else {
            System.out.println(nombrePais + "no se encuentra en la lista.");
            return null; //Si fuera double, 0
        }
    }
